...
glVertexAttribFormat: *const fn (attribindex: c_uint, size: c_int, @"type": @"enum", normalized: @"bool", relativeoffset: c_uint) callconv(APIENTRY) void,
...
glVertexArrayAttribFormat: *const fn (vaobj: c_uint, attribindex: c_uint, size: c_int, @"type": @"enum", normalized: @"bool", relativeoffset: c_uint) callconv(APIENTRY) void,
...
glVertexArrayVertexAttribFormatEXT: *const fn (vaobj: c_uint, attribindex: c_uint, size: c_int, @"type": @"enum", normalized: @"bool", relativeoffset: c_uint) callconv(APIENTRY) void,
